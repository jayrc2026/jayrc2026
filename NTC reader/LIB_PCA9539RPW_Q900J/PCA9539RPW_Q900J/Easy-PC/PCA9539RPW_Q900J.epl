SamacSys ECAD Model
11418995/909210/2.50/24/3/Integrated Circuit
...
(library Library_1
	...
	(patternDef "SOP65P640X110-24N" (originalName "SOP65P640X110-24N")
		(multiLayer
	...
	(symbolDef "PCA9539RPW_Q900J" (originalName "PCA9539RPW_Q900J")
	...
	(compDef "PCA9539RPW_Q900J" (originalName "PCA9539RPW_Q900J") (compHeader (numPins 24) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "IO0_0") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "IO0_1") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "IO0_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "IO0_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "IO0_4") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "IO0_5") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "IO0_6") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "11" (pinName "IO0_7") (partNum 1) (symPinNum 11) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "21" (pinName "A0") (partNum 1) (symPinNum 16) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "20" (pinName "IO1_7") (partNum 1) (symPinNum 17) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "19" (pinName "IO1_6") (partNum 1) (symPinNum 18) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "18" (pinName "IO1_5") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "17" (pinName "IO1_4") (partNum 1) (symPinNum 20) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "16" (pinName "IO1_3") (partNum 1) (symPinNum 21) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "15" (pinName "IO1_2") (partNum 1) (symPinNum 22) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "14" (pinName "IO1_1") (partNum 1) (symPinNum 23) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "13" (pinName "IO1_0") (partNum 1) (symPinNum 24) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PCA9539RPW_Q900J"))
		(attachedPattern (patternNum 1) (patternName "SOP65P640X110-24N")
			(numPads 24)
			(padPinMap
		...
		(attr "Mouser Part Number" "771-PCA9539RPW/Q900J")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/NXP-Semiconductors/PCA9539RPW-Q900J?qs=HXFqYaX1Q2xW7PmDtFxd6w%3D%3D")
		(attr "Manufacturer_Name" "NXP")
		(attr "Manufacturer_Part_Number" "PCA9539RPW/Q900J")
		(attr "Description" "Interface - I/O Expanders 16-bit I2C-bus and SMBus low power I/O port with interrupt and reset")
		(attr "Datasheet Link" "http://www.nxp.com/docs/en/data-sheet/PCA9539_PCA9539R.pdf")
		(attr "Height" "1.1 mm")
	)
